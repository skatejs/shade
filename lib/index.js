(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './api/bind', './api/bindings', './api/listen', './api/notify', './binding/attr', './binding/checked', './binding/content', './binding/if', './binding/name', './binding/text', './util/fragment-from-collection', './util/fragment-from-string'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./api/bind'), require('./api/bindings'), require('./api/listen'), require('./api/notify'), require('./binding/attr'), require('./binding/checked'), require('./binding/content'), require('./binding/if'), require('./binding/name'), require('./binding/text'), require('./util/fragment-from-collection'), require('./util/fragment-from-string'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiBind, global.apiBindings, global.apiListen, global.apiNotify, global.bindingAttr, global.bindingChecked, global.bindingContent, global.bindingIf, global.bindingName, global.bindingText, global.fragmentFromCollection, global.fragmentFromString);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _apiBind, _apiBindings, _apiListen, _apiNotify, _bindingAttr, _bindingChecked, _bindingContent, _bindingIf, _bindingName, _bindingText, _utilFragmentFromCollection, _utilFragmentFromString) {
  'use strict';
  ...
  function create() {
    function define() {
      ...
      return function (el) {
        ...
        initialContent = (0, _fragmentFromCollection['default'])(el.childNodes);
