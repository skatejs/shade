(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../constants', './content/make-property', '../util/trim', './content/wrap'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../constants'), require('./content/make-property'), require('../util/trim'), require('./content/wrap'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.constants, global.makeProperty, global.trim, global.wrap);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _constants, _contentMakeProperty, _utilTrim, _contentWrap) {
  'use strict';
