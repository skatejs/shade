(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../event/listen'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../event/listen'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.eventListen);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _eventListen) {
  'use strict';
