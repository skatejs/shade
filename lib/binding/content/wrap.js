(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../../event/notify', '../../util/find-nodes-between', '../../util/fragment-from-anything', '../../util/fragment-from-collection'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../../event/notify'), require('../../util/find-nodes-between'), require('../../util/fragment-from-anything'), require('../../util/fragment-from-collection'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.eventNotify, global.findNodesBetween, global.fragmentFromAnything, global.fragmentFromCollection);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _eventNotify, _utilFindNodesBetween, _utilFragmentFromAnything, _utilFragmentFromCollection) {
  'use strict';
  ...
  module.exports = function (content) {
    function addDefaultNodes() {
      if (!content.__initialised) {
        ...
        reference.parentNode.insertBefore((0, _fragmentFromCollection['default'])(content.__default), reference);
      }
    }
